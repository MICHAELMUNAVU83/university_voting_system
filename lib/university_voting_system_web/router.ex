defmodule UniversityVotingSystemWeb.Router do
  use UniversityVotingSystemWeb, :router

  import UniversityVotingSystemWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, {UniversityVotingSystemWeb.LayoutView, :root}
  ...
  scope "/", UniversityVotingSystemWeb do
    pipe_through :browser

    live "/", PageLive.Index, :index
    live "/register_contestant", RegisterContestantLive.Index, :index
    live "/vote_for_position", VoteForPositionLive.Index, :index
    live "/vote_for_position/:id", VoteForPositionLive.Show, :show
  ...
  # scope "/api", UniversityVotingSystemWeb do
  #   pipe_through :api
  # end
  ...
  if Mix.env() in [:dev, :test] do
    ...
    scope "/" do
      ...
      live_dashboard "/dashboard", metrics: UniversityVotingSystemWeb.Telemetry
    end
  end
