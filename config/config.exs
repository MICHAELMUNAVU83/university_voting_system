...
config :university_voting_system,
  ecto_repos: [UniversityVotingSystem.Repo]
...
config :university_voting_system, UniversityVotingSystem.Mailer, adapter: Swoosh.Adapters.Local
